        ...
        <section className="card">
          <div className="grid">
            ...
            <div className="gridTwoCols">
              ...
              <label className="switchRow fullRow"><input type="checkbox" checked={collaboratorForm.active} onChange={(e) => setCollaboratorForm({ ...collaboratorForm, active: e.target.checked })} /> Collaboratore attivo nell'app prenotazioni</label>
            </div>

            <div className="sectionTitle">Giorni fissi di riposo del collaboratore</div>
            ...
            <div className="sectionTitle">Orari personalizzati collaboratore</div>
            ...
            <div className="sectionTitle">Ferie / assenze del collaboratore</div>
            ...
            <div className="bookingActions">
              <button className="btn" onClick={saveCollaborator} disabled={savingCollaborator || (!collaboratorForm.id && collaborators.length >= 5)}>{savingCollaborator ? "Salvo..." : "Salva collaboratore"}</button>
              <button className="tabBtn secondaryBtn" onClick={() => { setCollaboratorForm(emptyCollaborator()); setNewCollaboratorHoliday(""); }}>Nuovo collaboratore</button>
            </div>

            <div className="sectionTitle">Elenco collaboratori</div>
