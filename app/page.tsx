    ...
    try {
      ...
      const collaboratorSummary =
        data.bookings
          ...
          .join(" | ") ||
        (preferredCollaborator?.name || "Assegnazione automatica");
...
<header className="hero">
  <div className="brand">
    <div className="title">Salon Estetica</div>
    <p className="subtitle">Prenota il tuo trattamento in pochi secondi</p>
      ...
      <section className="card">
        <div className="grid">
          ...
          <div>
            <label>Collaboratore preferito</label>
          ...
          <div className="badge info">
            Con più persone, la web app assegna automaticamente collaboratori liberi nello stesso orario.
          </div>
        </div>
      </section>
    </main>
